...
describe('types', function () {
    describe('<color>', function () {
        describe('parsing', function () {
            ...
            it('color(srgb 0 0 0)', function () { return assert_1.strictEqual(parse('color(srgb 0 0 0)'), color_1.pack(0, 0, 0, 1)); });
            it('color(srgb 1 1 1)', function () { return assert_1.strictEqual(parse('color(srgb 1 1 1)'), color_1.pack(255, 255, 255, 1)); });
            it('color(srgb 0.5 0.5 0.5)', function () { return assert_1.strictEqual(parse('color(srgb 0.5 0.5 0.5)'), color_1.pack(128, 128, 128, 1)); });
            it('color(srgb 0 0 0 / 0.5)', function () { return assert_1.strictEqual(parse('color(srgb 0 0 0 / 0.5)'), color_1.pack(0, 0, 0, 0.5)); });
            it('color(srgb 0 0 0 / 0.85)', function () { return assert_1.strictEqual(parse('color(srgb 0 0 0 / 0.85)'), color_1.pack(0, 0, 0, 0.85)); });
            it('color(srgb 1 0.5 0)', function () { return assert_1.strictEqual(parse('color(srgb 1 0.5 0)'), color_1.pack(255, 128, 0, 1)); });
            it('color(display-p3 1 0 0)', function () { return assert_1.strictEqual(parse('color(display-p3 1 0 0)'), color_1.pack(255, 0, 0, 1)); });
            it('color(srgb 100% 0% 50%)', function () { return assert_1.strictEqual(parse('color(srgb 100% 0% 50%)'), color_1.pack(255, 0, 128, 1)); });
            it('color(srgb 50% 50% 50% / 25%)', function () { return assert_1.strictEqual(parse('color(srgb 50% 50% 50% / 25%)'), color_1.pack(128, 128, 128, 0.25)); });
        });
